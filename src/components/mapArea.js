...
class MapArea extends React.PureComponent {
  ...
  render(){
    return(
      <>
        <area onClick={this.handleSvgClick.bind(this, this.props.elPos)} style={{cursor: "pointer", userSelect: "none"}} alt={this.props.titleName} title={this.props.pointName} coords={`${this.props.xAxis}, ${this.props.yAxis}, ${this.props.markType === "markSpawn" ? "32" : "16"}`} shape="circle" />
      </>
    )
  }
}
